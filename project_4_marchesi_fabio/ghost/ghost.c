...
int main(int argc, char *argv[])
{
    ...
    // data_ghost
	// I created 2 datatypes one for sending a row of the matrix and the other for sending a column of the matrix
	// I can use the first type to send the first and last row up and down 
	// And use the latter to send the columns to the left and to the right
	...
	MPI_Type_free(&data_ghost_column);
