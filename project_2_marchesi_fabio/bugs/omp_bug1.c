...
// The error is that after the directive omp parallel for there must be only a for loop
// If we want to also do other stuff we have to split the block, doing a "parallel" before and 
// After using "loop"
